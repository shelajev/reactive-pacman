...
export default class PlayerServiceClientSharedAdapter implements PlayerService {
    ...
    constructor() {
        ...
        this.service = new GRPCWebServices.PlayerServiceClient(endpoint || "http://URL_REPLACE_ME:8000", {}, {});
        this.locationServiceFallback = new GRPCWebServices.LocationServiceClient(endpoint || "http://URL_REPLACE_ME:8000", {}, {});
    }
